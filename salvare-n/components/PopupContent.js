...
const L = dynamic(() => import('leaflet').then((mod) => mod.L), {
...
const PopupContent = ({ pin, cont, setId, isOpen, closeModal }) => {
  ...
  const centerLocation = [
    (parseInt(pin.recyclingCenter.recyclingCenterLatitude._hex) +
      parseInt(pin.trashCanLatitude._hex)) /
      100000000000000 /
      2,
    (parseInt(pin.recyclingCenter.recyclingCenterLongitude._hex) +
      parseInt(pin.trashCanLongitude._hex)) /
      100000000000000 /
      2
  ];
  ...
  const manIcon = L.icon({
    iconUrl:
      'https://cdn.discordapp.com/attachments/1105178218748710952/1115840689968795760/emoji_people_FILL1_wght400_GRAD0_opsz48.png',
    iconSize: [41, 41],
    iconAnchor: [20, 11],
    popupAnchor: [0, -41]
  });
  ...
  const factoryIcon = L.icon({
    iconUrl:
      'https://cdn.discordapp.com/attachments/1105178218748710952/1115836138343649281/factory_FILL1_wght400_GRAD0_opsz48.png',
    iconSize: [60, 60],
    iconAnchor: [31, 41],
    popupAnchor: [0, -41]
  });
